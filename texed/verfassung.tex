...
\subsubsection{Artikel 4 (Religionsfreiheit)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 5 (Meinungsfreiheit)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 6 (Ehe und Familie)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 7 (Versammlungsfreiheit)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 8 (Vereinsfreiheit)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 9 (Briefgeheimnis)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 10 (Innerstaatliche Freiz\"{u}gigkeit)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 11 (Freiheit der Berfuswahl)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 12 (Privatsph\"{a}re)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 13 (Recht auf Eigentum)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 14 (Demokratiegrundlage)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 15 (Einschr\"{a}nkung der Grundrechte)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\section{Der Staat}
\subsubsection{Artikel 16 (Staatsform)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 17 (Staatsangeh\"{o}rigkeit)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 18 (Staatsgebiet)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 19 (Wahlrecht)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 20 (Pr\"{a}sidentin)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsection{Die Legislative}
\subsubsection{Artikel 21 (Parlamentsgrunds\"{a}tze)}
\begin{enumerate}[label=$($\arabic*$)$]
	...
	\item Dem Parlament sitzt eine Parlamentspräsidentin vor, die aus dem Kreis der Abgeordneten benannt wird, die Diskussionen leitet und darauf achtet, dass die Geschäftsordnung eingehalten wird. Sie wird von dem gesamten Parlament gewählt und ist eine Legislaturperiode im Amt.\end{enumerate}

\subsubsection{Artikel 22 (Aufgaben des Parlamentes)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 23 (Abgeordnete)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 24 (Beziehung zwischen Regierung und Parlament)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 25 (Gesch\"{a}ftsordnung)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsection{Die Exekutive}
\subsubsection{Artikel 26 (Kanzlerin)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 27 (Regierung)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 28 (Staatsanwaltschaft)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 29 (Polizei und Gewaltenmonopol)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsection{Judikative}
\subsubsection{Artikel 30 (Verfassungsgericht)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 31 (Zivil- und Strafgericht)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 32 (Öffentlichkeit und Unabh\"{a}ngigkeit der Justiz)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsection{Die Verfassung}
\subsubsection{Artikel 33 (Ewigkeitsklausel)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 34 (Verfassungsänderung und -einhaltung)}
\begin{enumerate}[label=$($\arabic*$)$]
...
\subsubsection{Artikel 35 (Einschränkung der Verfassung)}
\begin{enumerate}[label=$($\arabic*$)$]
